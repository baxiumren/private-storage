...
.gear{font-size:52px;margin-bottom:10px;display:inline-block;animation:spin 5s linear infinite;}
...
<div class="wrap">
    ...
    <div class="line"></div>
    <h1>Server Lagi Sibuk / Maintenance</h1>
    <p>Layanan sedang tidak tersedia sementara. Tunggu beberapa menit, terus coba lagi ya.</p>
